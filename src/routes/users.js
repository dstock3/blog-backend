...
/* Create user profile */
router.post('/register', upload.single('img'), user_controller.user_create_post);

/* Update user profile */
router.put('/:username/update', [verify, upload.single('img')], user_controller.user_update_put);
